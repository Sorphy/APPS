...
void* bubbleSortAscAsync(void* arguments){
    ...
    bubbleSortAsc(args->data, args->length);
}

void* bubbleSortDescAsync(void* arguments){
    Arguments* args = (Arguments*)arguments;
    bubbleSortDesc(args->data, args->length);
}

void* selectionSortAscAsync(void* arguments){
    Arguments* args = (Arguments*)arguments;
    selectionSortAsc(args->data, args->length);
}

void* selectionSortDescAsync(void* arguments){
    Arguments* args = (Arguments*)arguments;
    selectionSortDesc(args->data, args->length);
}

void* insertionSortAscAsync(void* arguments){
    Arguments* args = (Arguments*)arguments;
    insertionSortAsc(args->data, args->length);
}
...
void copyArray(int* arr, int* output, int length){
...
int main()
{
	...
	for (int i = 0; i < M; i++) {
		...
		mergeArraysDesc(output, arguments[i].data, size_o, arguments[i].length, tmp);
		output = tmp;
		size_o = s;
	}
